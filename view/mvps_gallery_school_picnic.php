        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav">
                    ...
                    <span class="lnr lnr-arrow-right"></span><a href="<?php echo $base_url; ?>school-picnic"> School Picnic</a>
                </p>
            </div>  
        </div>
    </div>
...
<div class="container">
    ...
    <div class="tz-gallery">
        <div class="row">
            <?php
                $dir2 = glob('img/gallery/schoolPicnic/{*.JPG,*.jpg,*.PNG,*.png}',GLOB_BRACE); 
